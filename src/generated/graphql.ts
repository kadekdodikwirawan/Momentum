...
/** Input for the createUndangan mutation */
export type CreateUndanganInput = {
  canva_link?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']>;
  ...
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars['Int']>;
  musik_link?: InputMaybe<Scalars['String']>;
  /** The password used to protect the content of the object */
  password?: InputMaybe<Scalars['String']>;
  /** The slug of the object */
  slug?: InputMaybe<Scalars['String']>;
...
/** The payload for the createUndangan mutation */
export type CreateUndanganPayload = {
  __typename?: 'CreateUndanganPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  undangan?: Maybe<Undangan>;
};
...
/** Input for the deleteUndangan mutation */
export type DeleteUndanganInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']>;
  /** The ID of the Undangan to delete */
  id: Scalars['ID'];
};

/** The payload for the deleteUndangan mutation */
export type DeleteUndanganPayload = {
  __typename?: 'DeleteUndanganPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
export type MenuItemObjectUnion = Category | Page | Post | Tag | Undangan;
...
export type RootMutation = {
  ...
  /** The payload for the createUndangan mutation */
  createUndangan?: Maybe<CreateUndanganPayload>;
  /** The payload for the createUser mutation */
  ...
  /** The payload for the deleteUndangan mutation */
  deleteUndangan?: Maybe<DeleteUndanganPayload>;
  /** The payload for the deleteUser mutation */
  ...
  /** The payload for the updateUndangan mutation */
  updateUndangan?: Maybe<UpdateUndanganPayload>;
...
/** The root mutation */
export type RootMutationCreateUndanganArgs = {
  input: CreateUndanganInput;
};
...
/** The root mutation */
export type RootMutationDeleteUndanganArgs = {
  input: DeleteUndanganInput;
};
...
/** The root mutation */
export type RootMutationUpdateUndanganArgs = {
  input: UpdateUndanganInput;
};
...
export type RootQuery = {
  ...
  /** An object of the Undangan Type. */
  undangan?: Maybe<Undangan>;
  /**
   * A Undangan object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  undanganBy?: Maybe<Undangan>;
  /** Connection between the RootQuery type and the Undangan type */
  undangans?: Maybe<RootQueryToUndanganConnection>;
  /** Returns a user */
  user?: Maybe<User>;
  /** Returns a user role */
...
/** The root entry point into the Graph */
export type RootQueryUndanganArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<UndanganIdType>;
};


/** The root entry point into the Graph */
export type RootQueryUndanganByArgs = {
  id?: InputMaybe<Scalars['ID']>;
  slug?: InputMaybe<Scalars['String']>;
  undanganId?: InputMaybe<Scalars['Int']>;
  uri?: InputMaybe<Scalars['String']>;
};


/** The root entry point into the Graph */
export type RootQueryUndangansArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToUndanganConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the Undangan type */
export type RootQueryToUndanganConnection = {
  __typename?: 'RootQueryToUndanganConnection';
  /** Edges for the RootQueryToUndanganConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToUndanganConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Undangan>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
};

/** An edge in a connection */
export type RootQueryToUndanganConnectionEdge = {
  __typename?: 'RootQueryToUndanganConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Undangan>;
...
/** Arguments for filtering the RootQueryToUndanganConnection connection */
export type RootQueryToUndanganConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** The Undangan type */
export type Undangan = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Undangan';
  /** The content of the post. */
  content?: Maybe<Scalars['String']>;
  /** Connection between the ContentNode type and the ContentType type */
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the undangan object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
  ...
  /** The permalink of the post */
  link?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Undangan&quot; was set to Show in GraphQL. */
  meta?: Maybe<Undangan_Meta>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Connection between the Undangan type and the Undangan type */
  preview?: Maybe<UndanganToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
...
/** The Undangan type */
export type UndanganContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Undangan type */
export type UndanganEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The Undangan type */
export type UndanganEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The Undangan type */
export type UndanganTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum UndanganIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the Undangan type and the Undangan type */
export type UndanganToPreviewConnectionEdge = {
  __typename?: 'UndanganToPreviewConnectionEdge';
  /** The node of the connection, without the edges */
  node?: Maybe<Undangan>;
};

/** Field Group */
export type Undangan_Meta = AcfFieldGroup & {
  __typename?: 'Undangan_Meta';
  canvaLink?: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  musikLink?: Maybe<Scalars['String']>;
};
...
/** Input for the updateUndangan mutation */
export type UpdateUndanganInput = {
  canva_link?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The content of the object */
...
/** The payload for the updateUndangan mutation */
export type UpdateUndanganPayload = {
  __typename?: 'UpdateUndanganPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  undangan?: Maybe<Undangan>;
...
export type Get_UndangansQueryVariables = Exact<{ [key: string]: never; }>;


export type Get_UndangansQuery = { __typename?: 'RootQuery', undangans?: { __typename?: 'RootQueryToUndanganConnection', nodes?: Array<{ __typename?: 'Undangan', slug?: string | null } | null> | null } | null };

export const Get_UndangansDocument = gql`
    query GET_UNDANGANS {
  undangans {
    nodes {
      slug
...
export class Get_UndangansGQL extends Apollo.Query<Get_UndangansQuery, Get_UndangansQueryVariables> {
  document = Get_UndangansDocument;
